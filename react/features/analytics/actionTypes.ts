/**
 * The type of (redux) action which clears the initial permanent props object.
 *
 * {
 *     type: CLEAR_INITIAL_PERMANENT_PROPERTIES,
 * }
 */
export const CLEAR_INITIAL_PERMANENT_PROPERTIES = 'CLEAR_INITIAL_PERMANENT_PROPERTIES';
